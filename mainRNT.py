...
if uploaded_file:
    ...
    if st.button("🚀 Procesar RNT"):
        ...
        with st.spinner("Procesando RNT..."):
            ...
            # Guardamos en memoria de sesión
            st.session_state["detalle"] = detalle_mensual
            st.session_state["resumen"] = resumen_anual
            st.session_state["paginas_error"] = paginas_con_error


# =====================================================
# SI YA HEMOS PROCESADO → MOSTRAR RESULTADOS
# =====================================================

if "resumen" in st.session_state:

    detalle_mensual = st.session_state["detalle"]
    resumen_anual = st.session_state["resumen"]
    paginas_con_error = st.session_state["paginas_error"]
    ...
    if not resumen_anual:
        ...
        if meses_faltantes:
            st.warning(
                ...
                "Puede haber páginas no legibles o mal formateadas."
            )
